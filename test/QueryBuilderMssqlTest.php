...
class QueryBuilderMssqlTest extends PHPUnit_Framework_TestCase {
    ...
    public function testFindOneWithPrimaryKeyFilter() {
        ...
        $expected = "SELECT TOP 1 * FROM widget WHERE id = '5'";
        $this->assertEquals($expected, ORM::get_last_query());
    }
    ...
    public function testSingleWhereClause() {
        ...
        $expected = "SELECT TOP 1 * FROM widget WHERE name = 'Fred'";
        $this->assertEquals($expected, ORM::get_last_query());
    }

    public function testMultipleWhereClauses() {
        ORM::for_table('widget')->where('name', 'Fred')->where('age', 10)->find_one();
        $expected = "SELECT TOP 1 * FROM widget WHERE name = 'Fred' AND age = '10'";
        $this->assertEquals($expected, ORM::get_last_query());
    }
    ...
    public function testWhereLike() {
        ...
        $expected = "SELECT TOP 1 * FROM widget WHERE name LIKE '%Fred%'";
        $this->assertEquals($expected, ORM::get_last_query());
    }

    public function testWhereNotLike() {
        ORM::for_table('widget')->where_not_like('name', '%Fred%')->find_one();
        $expected = "SELECT TOP 1 * FROM widget WHERE name NOT LIKE '%Fred%'";
        $this->assertEquals($expected, ORM::get_last_query());
    }
    ...
    public function testHaving() {
        ...
        $expected = "SELECT TOP 1 * FROM widget GROUP BY name HAVING name = 'Fred'";
        $this->assertEquals($expected, ORM::get_last_query());
    }

    public function testMultipleHaving() {
        ORM::for_table('widget')->group_by('name')->having('name', 'Fred')->having('age', 10)->find_one();
        $expected = "SELECT TOP 1 * FROM widget GROUP BY name HAVING name = 'Fred' AND age = '10'";
        $this->assertEquals($expected, ORM::get_last_query());
    }
    ...
    public function testHavingLike() {
        ...
        $expected = "SELECT TOP 1 * FROM widget GROUP BY name HAVING name LIKE '%Fred%'";
        $this->assertEquals($expected, ORM::get_last_query());
    }

    public function testHavingNotLike() {
        ORM::for_table('widget')->group_by('name')->having_not_like('name', '%Fred%')->find_one();
        $expected = "SELECT TOP 1 * FROM widget GROUP BY name HAVING name NOT LIKE '%Fred%'";
        $this->assertEquals($expected, ORM::get_last_query());
    }
    ...
    public function testComplexQuery() {
        ORM::for_table('widget')->where('name', 'Fred')->limit(5)->order_by_asc('name')->find_many();
        $expected = "SELECT TOP 5 * FROM widget WHERE name = 'Fred' ORDER BY name ASC";
        $this->assertEquals($expected, ORM::get_last_query());
    }
    ...
    public function testSimpleJoinWithWhereIdIsMethod() {
        ...
        $expected = "SELECT TOP 1 * FROM widget JOIN widget_handle ON widget_handle.widget_id = widget.id WHERE widget.id = '5'";
        $this->assertEquals($expected, ORM::get_last_query());
    }
    ...
    public function testCount() {
        ...
        $expected = "SELECT TOP 1 COUNT(*) AS count FROM widget";
        $this->assertEquals($expected, ORM::get_last_query());
    }

    public function testMax() {
        ORM::for_table('person')->max('height');
        $expected = "SELECT TOP 1 MAX(height) AS max FROM person";
        $this->assertEquals($expected, ORM::get_last_query());
    }

    public function testMin() {
        ORM::for_table('person')->min('height');
        $expected = "SELECT TOP 1 MIN(height) AS min FROM person";
        $this->assertEquals($expected, ORM::get_last_query());
    }

    public function testAvg() {
        ORM::for_table('person')->avg('height');
        $expected = "SELECT TOP 1 AVG(height) AS avg FROM person";
        $this->assertEquals($expected, ORM::get_last_query());
    }

    public function testSum() {
        ORM::for_table('person')->sum('height');
        $expected = "SELECT TOP 1 SUM(height) AS sum FROM person";
        $this->assertEquals($expected, ORM::get_last_query());
    }
    ...
    public function testIssue12IncorrectQuotingOfColumnWildcard() {
        ...
        $expected = "SELECT TOP 1 widget.* FROM widget";
        $this->assertEquals($expected, ORM::get_last_query());
    }
